...
The $not\_my\_fav$ parameter, we can see the effct of rating a non-prefered wine. This is a very small effect, with the confidence intervals including 0 in both. We may have some slight bias among white wine preferers ($not\_my\_fav[2]$).
